...
const Projects: React.FC<ProjectsProps> = ({ onHover, onLeave }) => {
    ...
    return (
        <div id="projects" className="min-h-full w-full flex flex-col justify-start md:justify-center max-w-[1400px] mx-auto pt-24 pb-12 md:py-20 relative px-4 md:px-12">
            ...
            <div className="z-10 w-full flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-32 items-center lg:items-start">
                ...
                <div className="w-full lg:w-[35%] flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    >
                        {t('projects.featuredProjects').split(' ')[0]} <br className="hidden md:block" />
                        {t('projects.featuredProjects').split(' ')[1]}
                    </h3>
